...
<div class="container">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <div>
            ...
            <h2 style="margin: 10px 0 0 0; font-weight: 800;">🏠 Monitoring Pembayaran Kos</h2>
        </div>
        <div style="display: flex; gap: 10px;">
            ...
            <a href="riwayat_kos.php" class="btn" style="background: #1e293b; color: white;">⚙️ Kelola Hunian</a>
        </div>
    </div>
    ...
    <div class="glass-card">
        <form class="toolbar" method="GET">
            <div class="search-box">
                <input type="text" name="search" placeholder="Cari nama penghuni..." value="<?php echo htmlspecialchars($search); ?>">
                <select name="bulan">
            ...
            <tbody>
                <?php if(mysqli_num_rows($query) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td><span class="btn" style="background:#f1f5f9; padding: 5px 10px; font-size:0.8rem;">Kamar <?php echo $row['no_kamar']; ?></span></td>
                        <td>
